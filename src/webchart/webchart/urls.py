...
from wordtimes import views

urlpatterns = [
    path('', views.home, name='home'),
    path('words/', views.columns_view, name='words'),
    path('pieview/', views.pieview, name='pieview'),
    path('pieview/chart_data/', views.chart_data, name='chart_data'),
